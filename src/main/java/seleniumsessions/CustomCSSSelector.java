...
public class CustomCSSSelector {
	...
	public static void main(String[] args) {
		...
		// Address']#input-email[class='form-control']
		...
		// select#Form_getForm_Country > option:nth-last-child(3) --from the last fetch
		// 3rd elemenet
		...
		// child to parent and child to ancestor: no support for backward traversing in
		// CSS
		...
		// Albania -- only immediate sibling
		// select#Form_getForm_Country > option[value='Afghanistan'] ~ option -- all 231
		// following siblings

		// comma in css:
		String impEleCSS = "img.img-responsive,input#input-email,input#input-password,input[value='Login']"; // -- 4
																												// elements
