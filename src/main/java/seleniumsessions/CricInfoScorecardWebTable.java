...
public class CricInfoScorecardWebTable {
	...
	public static void main(String[] args) throws InterruptedException {
		...
		//batting details only
		//table//tr[@class='ds-text-right']/th[text()='Batting']/ancestor::thead/following-sibling::tbody/tr//span[text()='Tajinder Singh']/ancestor::td/following-sibling::td[contains(@class,'ds-text-right')]
	...
	public static List<String> getScoreCardList(String playername) {
		...
		List<WebElement> scoreCardList = driver.findElements(By.xpath("//span[text()='" + playername+ "']//ancestor::td/following-sibling::td[contains(@class,'ds-text-right')]"));
